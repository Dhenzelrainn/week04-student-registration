...
- Maximum profile picture size of 5 MB
...
| Profile Picture | Required, image, JPG/JPEG/PNG, max 5 MB | Restricts invalid or oversized uploads |
...
Upload a file that is not JPG, JPEG, or PNG, or use an image larger than 5 MB.
